...
?>
    ...
    <script>
            ...
            var deactivateButton = document.getElementById("deactivate-oauth-client-login-integration-with-oauth-server");
            console.log(deactivateButton)

            jQuery('#deactivate-oauth-client-login-for-wordpress').on('click', function(e) {
